...
import { CALCULATOR_MAPPINGS, calculatorGroupItems as groupItems } from "@/constants/calculators";
      ...
      <div className="px-4 my-8">
        <div className=" p-5 border-round bg-white shadow-1">
          ...
          <div className="mt-0 mb-4">
            <SearchBox handleSearch={handleSearch} loading={loading} inputRef={searchBoxRef} />
          </div>
