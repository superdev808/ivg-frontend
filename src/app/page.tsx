    ...
    <>
      <div className={cx("grid -mt-8 md:pt-6", "landing-top")}>
        ...
        <div className="col-12 md:col-5 relative">
          <div
            className={cx("landing-top-image-container", "static md:absolute")}
          >
            <div
              className={cx(
                "landing-top-image-sub-container",
                "static md:relative"
              )}
            >
              <Image
      ...
      <div className={cx("grid mt-4 md:mt-8", "landing-middle")}>
        ...
        <div className="col-12 md:col-6 md:col-offset-3 mt-4 px-6 flex justify-content-center">
          <h2 className={cx("landing-middle-description")}>
            ...
            , you gain easy and instantaneous access to trustworthy clinical and
            manufacturer recommendations, allowing you to easily troubleshoot
            cases and develop treatment plans while your patient is in the
            chair.
          </h2>
        </div>
      </div>
          ...
          <div className="col-12 grid py-4 flex justify-content-center">
            ...
            >
              ...
              <h5
                className={cx(
                  ...
                  "mt-6 px-2 text-sm md:text-xl font-light"
                )}
              >
                Our technology can uplevel your practice's patient care while
                guiding you and your staff through complicated workflows,
                material selection, and issues that can arise while patients are
                in chair.
              </h5>
            </div>
            <div
            ...
            >
              ...
              >
                ...
                allowing your technicans to spend more time on the floor and
            ...
            >
              ...
              >
                ...
                tools provide future clinicians, assistants, and technicans with
                an additional resource to leverage while they are learning the
      ...
      <div className={cx("grid my-6 py-6", "landing-missing-section")}>
        <div className="col-12 flex flex-column align-items-center">
          <p
            className={cx(
              "landing-missing-section-title",
              "my-2 px-2 text-xl md:text-6xl"
            )}
          >
            What are we missing?
          </p>
          <p
            className={cx(
              "landing-missing-section-description",
              "my-1 px-2 text-lg md:text-xl text-center"
            )}
          >
