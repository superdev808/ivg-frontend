...
export const BYPASS_AUTH_ROUTES = [PUBLIC_AUTH_ROUTES.RESET_PASSWORD, PUBLIC_ROUTES.PRIVACY, PUBLIC_ROUTES.PRIVACYCA, PUBLIC_ROUTES.AGREEMENT, PUBLIC_ROUTES.FORBIDDEN];
