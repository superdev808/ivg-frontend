		...
		<>
			<div className="flex flex-column w-full md:w-6 text-center">
                ...
                <span className="text-600 font-medium text-xl my-2 line-height-2">
					 <Link href={'/forgot-password'} className='text-secondary'>Click here</Link> to get a new link. If you already set the password, please click below to sign in with your valid credentials.
				</span>
				<span className="text-600 font-medium text-xl my-4 line-height-2">
					Still stuck? Please <Link href={'/contact'} className='text-secondary'>contact us</Link> if you need additional assistance.
				</span>
