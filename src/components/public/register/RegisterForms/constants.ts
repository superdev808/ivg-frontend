...
export const dentalPracticeRole: DentalPracticeRole[] = [
	...
	{ label: 'Pediatric Dentist', value: DENTAIL_PRACTICE_ROLE.PEDIATRIC_DENTIST },
	{ label: 'Orthodontist', value: DENTAIL_PRACTICE_ROLE.ORTHODONTIST },
	{ label: 'Perodontist', value: DENTAIL_PRACTICE_ROLE.PERODOINTIST },
