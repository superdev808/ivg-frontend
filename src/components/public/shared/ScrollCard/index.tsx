...
export const ScrollCard = ({ description, rtl, ...props }: ScrollCardProps) => {
	...
	return (
		<div
			...
			ref={cardRef}
			style={{ opacity: 0 }}>
			<div className={cx('card', 'flex z-2', { 'flex-order-1': rtl })}>{description}</div>
			<div
				className={cx('line-container', { 'flex-grow-1': !props.className }, props.className)}
				style={{ direction: rtl ? 'rtl' : 'ltr' }}>
				<div
					ref={lineRef}
					className={cx('relative', 'flex align-items-center')}
					...
					<svg
						...
						<g>
							<circle
								style={{ stroke: 'var(--primary-color)', fillOpacity: '0', strokeWidth: '2', strokeDasharray: 'none', strokeOpacity: '1' }}
								cx="15"
								cy="15"
								r="9"
							/>
